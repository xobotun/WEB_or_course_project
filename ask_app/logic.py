...
temporary_question_list = [
	...
	{ 'id': 3, 'author': {'name': 'Author', 'userpic_path': 'http://lorempixel.com/100/100', 'id': 999}, 'rating': 9, 'title': 'Ode', 'text': 'Ode to my laziness!..', 'tags': {'tag1name':'BakaWrongTag'}, 'comments_amount': 1 },
	{ 'id': 4, 'author': {'name': 'User 4', 'userpic_path': 'http://lorempixel.com/100/100', 'id': 3}, 'rating': -1, 'title': 'HELP ME!!!! URGENt!!!1', 'text': 'wheres ussr niumer 3??????', 'tags': {'tag1name':'HALP111'}, 'comments_amount': 132 },
