...
temporary_question_list = [
	...
	{ 'id': 2, 'author': {'name': 'User 2', 'userpic_path': 'http://lorempixel.com/100/100', 'id': 2}, 'rating': 0
	, 'title': 'Test', 'text': 'Testing test toster.', 'tags': {'tag1name':'test'}, 'comments_amount': 0 },
